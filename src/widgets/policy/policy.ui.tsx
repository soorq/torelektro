		...
		<div className='political__wrapper'>
			...
			<div className='political__text-wrapper'>
				<p className='political__text'>
					...
					(далее — политика) применяется ко всей информации, которая может быть получена
					оператором о посетителях интернет-сайта:
					<span>
					...
					данных с помощью средств специальной техники. <br />
					...
					а также программ специальной техники и баз данных, обеспечивающих их доступность
					...
					персональных данных конкретному субъекту. <br />
					...
					определяющие цели обработки и состав персональных данных, подлежащих обработке,
					...
					на раскрытие персональных данных неопределенному кругу лиц или на ознакомление
					...
					в информационно-телекоммуникационных сетях. <br />
					...
					наличии оснований, указанных в российском законодательстве.
					<br />
					— самостоятельно определять состав и перечень мер, необходимых и достаточных для
					обеспечения выполнения обязанностей, предусмотренных российским
					...
					данных от неправомерного доступа к ним, уничтожения, изменения, блокирования,
					копирования, предоставления, распространения персональных данных,
					<br /> а также от иных неправомерных действий в отношении персональных данных;{' '}
					<br />
					...
					данных действия или бездействие оператора. <br />
					...
					5.3. Хранение персональных данных осуществляется в форме, позволяющей определить
					субъекта персональных данных, не дольше,
					<br /> чем этого требуют цели обработки персональных данных, если срок хранения
				...
				<p className='political__text'>
					...
					8.2. Оператор обеспечивает сохранность персональных данных в форме, позволяющей
					...
					не установлен российским законодательством, договором, стороной которого,
					приобретателем по которому является субъект персональных данных. <br />
					...
					и обрабатывается указанным лицам (оператором) в соответствии с политикой
					...
					осуществления деятельности по трансграничной передаче персональных данных обязан
					уведомить уполномоченный орган по защите прав субъектов персональных данных
					о своем намерении осуществлять трансграничную передачу. <br />
					...
					разъяснения по интересующим вопросам, касающимся обработки персональных данных,
